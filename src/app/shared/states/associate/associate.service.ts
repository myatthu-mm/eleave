...
export class AssociateService {
  ...
  private _needtoRequestApplied_Obs$: BehaviorSubject<boolean> = new BehaviorSubject(false);
  private _needtoRequestApproved_Obs$: BehaviorSubject<boolean> = new BehaviorSubject(false);
  private _needtoRequestRejected_Obs$: BehaviorSubject<boolean> = new BehaviorSubject(false);
